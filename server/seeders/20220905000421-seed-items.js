  ...
  async up(queryInterface, DataTypes) {
    await queryInterface.bulkInsert(
      ...
      [
        ...
        {
          itemName: 'Apparatus of the Crab',
        ...
        {
          itemName: 'Armor of Invulnerability',
        ...
        {
          itemName: 'Armor of Vulnerability',
        ...
        {
          itemName: 'Arrow-Catching Shield',
        ...
        {
          itemName: 'Bead of Force',
          slug: 'bead-of-force',
          itemType: 'Wondrous item',
          itemDesc:
            "This small black sphere measures 3/4 of an inch in diameter and weighs an ounce. Typically, 1d4 + 4 _beads of force_ are found together.\n\nYou can use an action to throw the bead up to 60 feet. The bead explodes on impact and is destroyed. Each creature within a 10-foot radius of where the bead landed must succeed on a DC 15 Dexterity saving throw or take 5d4 force damage. A sphere of transparent force then encloses the area for 1 minute. Any creature that failed the save and is completely within the area is trapped inside this sphere. Creatures that succeeded on the save, or are partially within the area, are pushed away from the center of the sphere until they are no longer inside it. Only breathable air can pass through the sphere's wall. No attack or other effect can.\n\nAn enclosed creature can use its action to push against the sphere's wall, moving the sphere up to half the creature's walking speed. The sphere can be picked up, and its magic causes it to weigh only 1 pound, regardless of the itemWeight of creatures inside.",
          rarity: 'Rare',
          requiresAttunement: '',
          category: '',
          cost: '',
        ...
        {
          itemName: 'Belt of Giant Strength',
        ...
        {
          itemName: 'Brazier of Commanding Fire Elementals',
...

        {
          ...
          itemType: 'Wondrous item',
          itemDesc:
            "This small packet contains 1d6 + 4 pinches of dust. You can use an action to sprinkle a pinch of it over water. The dust turns a cube of water 15 feet on a side into one marble-sized pellet, which floats or rests near where the dust was sprinkled. The pellet's itemWeight is negligible.\n\nSomeone can use an action to smash the pellet against a hard surface, causing the pellet to shatter and release the water the dust absorbed. Doing so ends that pellet's magic.\n\nAn elemental composed mostly of water that is exposed to a pinch of the dust must make a DC 13 Constitution saving throw, taking 10d6 necrotic damage on a failed save, or half as much damage on a successful one.",
          rarity: 'Uncommon',
          requiresAttunement: '',
          category: '',
          cost: '',
...

        {
          ...
          rarity: 'Very Rare',
          requiresAttunement: 'Requires Attunement by a dwarf',
          category: '',
          cost: '',
          damageDice: '',
          damageType: '',
        ...
        {
          itemName: 'Figurine of Wondrous Power',
        ...
        {
          itemName: 'Glamoured Studded Leather',
          slug: 'glamoured-studded-leather',
          itemType: 'Armor (studded leather)',
          itemDesc:
            "While wearing this armor, you gain a +1 bonus to AC. You can also use a bonus action to speak the armor's command word and cause the armor to assume the appearance of a normal set of clothing or some other kind of armor. You decide what it looks like, including color, style, and accessories, but the armor retains its normal bulk and itemWeight. The illusory appearance lasts until you use this property again or remove the armor.",
          rarity: 'Rare',
          requiresAttunement: '',
          category: '',
          cost: '',
        ...
        {
          itemName: 'Gloves of Swimming and Climbing',
        ...
        {
          itemName: 'Headband of Intellect',
        ...
        {
          itemName: 'Helm of Comprehending Languages',
...

        {
          ...
          rarity: 'Legendary',
          requiresAttunement: 'Requires Attunement by a paladin',
          category: '',
          cost: '',
          damageDice: '',
          damageType: '',
...

        {
          ...
          itemType: 'Rod',
          itemDesc:
            "This flat iron rod has a button on one end. You can use an action to press the button, which causes the rod to become magically fixed in place. Until you or another creature uses an action to push the button again, the rod doesn't move, even if it is defying gravity. The rod can hold up to 8,000 pounds of itemWeight. More itemWeight causes the rod to deactivate and fall. A creature can use an action to make a DC 30 Strength check, moving the fixed rod up to 10 feet on a success.",
          rarity: 'Uncommon',
          requiresAttunement: '',
          category: '',
          cost: '',
        ...
        {
          itemName: 'Mantle of Spell Resistance',
        ...
        {
          itemName: 'Medallion of Thoughts',
...

        {
          ...
          rarity: 'Uncommon',
          requiresAttunement: 'Requires Attunement by a spellcaster',
          category: '',
          cost: '',
          damageDice: '',
          damageType: '',
        ...
        {
          itemName: 'Plate Armor of Etherealness',
        ...
        {
          itemName: 'Potion of Animal Friendship',
        ...
        {
          itemName: 'Potion of Clairvoyance',
        ...
        {
          itemName: 'Potion of Gaseous Form',
        ...
        {
          itemName: 'Potion of Giant Strength',
        ...
        {
          itemName: 'Potion of Mind Reading',
        ...
        {
          itemName: 'Ring of Animal Influence',
        ...
        {
          itemName: 'Ring of Djinni Summoning',
        ...
        {
          itemName: 'Ring of Elemental Command',
        ...
        {
          itemName: 'Ring of Feather Falling',
        ...
        {
          itemName: 'Ring of Shooting Stars',
          ...
          rarity: 'Very Rare',
          requiresAttunement: 'Requires Attunement outdoors at night',
          category: '',
          cost: '',
          damageDice: '',
          damageType: '',
        ...
        {
          itemName: 'Ring of Spell Turning',
...

        {
          ...
          rarity: 'Rare',
          requiresAttunement: 'Requires Attunement by a bard, cleric, or druid',
          category: '',
          cost: '',
          damageDice: '',
          damageType: '',
        ...
        {
          itemName: 'Staff of the Woodlands',
          ...
          rarity: 'Rare',
          requiresAttunement: 'Requires Attunement by a druid',
          category: '',
          cost: '',
          damageDice: '',
          damageType: '',
        ...
        {
          itemName: 'Stone of Good Luck (Luckstone)',
        ...
        {
          itemName: 'Wand of Enemy Detection',
        ...
        {
          itemName: 'Wand of Lightning Bolts',
        ...
        {
          itemName: 'Wand of Magic Detection',
        ...
        {
          itemName: 'Wand of the War Mage, +1, +2, or +3',
          slug: 'wand-of-the-war-mage-1-2-or-3',
          itemType: 'Wand',
          itemDesc:
            "While holding this wand, you gain a bonus to spell attack rolls determined by the wand's rarity. In addition, you ignore half cover when making a spell attack. [ uncommon (+1), rare (+2), or very rare (+3) ]",
          rarity: 'Varies',
          requiresAttunement: 'Requires Attunement by a spellcaster',
          category: '',
          cost: '',
        ...
        {
          itemName: 'Weapon, +1, +2, or +3',
          slug: 'weapon-1-2-or-3',
          itemType: 'Weapon (any)',
          itemDesc:
            "You have a bonus to attack and damage rolls made with this magic weapon. The bonus is determined by the weapon's rarity.[ uncommon(+1), rare (+2), or very rare (+3) ]",
          rarity: 'Varies',
          requiresAttunement: '',
          category: '',
          cost: '',
